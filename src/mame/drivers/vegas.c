...
CUSTOM_INPUT_MEMBER(vegas_state::custom_49way_r)
{
	...
	return (translate49[ioport(namey)->read() >> 4] << 0) | (translate49[ioport(namex)->read() >> 4] << 4);
}
...
static INPUT_PORTS_START( vegas_common )
	...
	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_INTERLOCK ) PORT_NAME("Slam") PORT_CODE(KEYCODE_Q) PORT_TOGGLE
...
static INPUT_PORTS_START( gauntdl )
	...
	PORT_DIPSETTING(      0x0040, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_DIPNAME( 0x0800, 0x0000, "SIO Rev" )
	PORT_DIPSETTING(      0x0800, "1 or later")
	PORT_DIPSETTING(      0x0000, "0")
	PORT_DIPNAME( 0x1000, 0x1000, "Harness" )
	PORT_DIPSETTING(      0x1000, "JAMMA" )
	PORT_DIPSETTING(      0x0000, "Midway" )
	PORT_DIPNAME( 0x2000, 0x0000, "Joysticks" )
	PORT_DIPSETTING(      0x2000, "8-Way" )
	PORT_DIPSETTING(      0x0000, "49-Way" )
	PORT_DIPNAME( 0xc000, 0x4000, "Resolution" )
	PORT_DIPSETTING(      0xc000, "Standard Res 512x256" )
	...
	PORT_MODIFY("IN1")
	PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_SPECIAL ) PORT_CUSTOM_MEMBER(DEVICE_SELF, vegas_state, custom_49way_r, "49WAY1X\0" "49WAY1Y" )
	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_SPECIAL ) PORT_CUSTOM_MEMBER(DEVICE_SELF, vegas_state, custom_49way_r, "49WAY2X\0" "49WAY2Y" )

	PORT_MODIFY("IN2")
	PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_SPECIAL ) PORT_CUSTOM_MEMBER(DEVICE_SELF, vegas_state, custom_49way_r, "49WAY3X\0" "49WAY3Y" )
	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_SPECIAL ) PORT_CUSTOM_MEMBER(DEVICE_SELF, vegas_state, custom_49way_r, "49WAY4X\0" "49WAY4Y" )

	/* Placeholder */
	//PORT_START("GUN1")
	//PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_UNUSED )
	//PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_PLAYER(1) /* Magic */
	//PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_UNUSED )
	//PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNUSED )
	//PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_UNUSED )
	//PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNUSED )
	//PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_PLAYER(1) /* Fight */
	//PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_PLAYER(1) /* Run */
	//PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_UNUSED )
	//PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_PLAYER(2) /* Magic */
	//PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_PLAYER(2) /* Fight */
	//PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_PLAYER(2) /* Run */

	/* Placeholder */
	//PORT_START("GUN2")
	//PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_UNUSED )
	//PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_PLAYER(3) /* Magic */
	//PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_UNUSED )
	//PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNUSED )
	//PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_UNUSED )
	//PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNUSED )
	//PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_PLAYER(3) /* Fight */
	//PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_PLAYER(3) /* Run */
	//PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_UNUSED )
	//PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_PLAYER(4) /* Magic */
	//PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_PLAYER(4) /* Fight */
	//PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_PLAYER(4) /* Run */

	PORT_START("49WAY1X")
	PORT_BIT( 0xff, 0x38, IPT_AD_STICK_X ) PORT_PLAYER(1) PORT_MINMAX(0x00,0x6f) PORT_SENSITIVITY(100) PORT_KEYDELTA(10)

	PORT_START("49WAY1Y")
	PORT_BIT( 0xff, 0x38, IPT_AD_STICK_Y ) PORT_PLAYER(1) PORT_MINMAX(0x00,0x6f) PORT_SENSITIVITY(100) PORT_KEYDELTA(10) PORT_REVERSE

	PORT_START("49WAY2X")
	PORT_BIT( 0xff, 0x38, IPT_AD_STICK_X ) PORT_PLAYER(2) PORT_MINMAX(0x00,0x6f) PORT_SENSITIVITY(100) PORT_KEYDELTA(10)

	PORT_START("49WAY2Y")
	PORT_BIT( 0xff, 0x38, IPT_AD_STICK_Y ) PORT_PLAYER(2) PORT_MINMAX(0x00,0x6f) PORT_SENSITIVITY(100) PORT_KEYDELTA(10) PORT_REVERSE

	PORT_START("49WAY3X")
	PORT_BIT( 0xff, 0x38, IPT_AD_STICK_X ) PORT_PLAYER(3) PORT_MINMAX(0x00,0x6f) PORT_SENSITIVITY(100) PORT_KEYDELTA(10)

	PORT_START("49WAY3Y")
	PORT_BIT( 0xff, 0x38, IPT_AD_STICK_Y ) PORT_PLAYER(3) PORT_MINMAX(0x00,0x6f) PORT_SENSITIVITY(100) PORT_KEYDELTA(10) PORT_REVERSE

	PORT_START("49WAY4X")
	PORT_BIT( 0xff, 0x38, IPT_AD_STICK_X ) PORT_PLAYER(4) PORT_MINMAX(0x00,0x6f) PORT_SENSITIVITY(100) PORT_KEYDELTA(10)

	PORT_START("49WAY4Y")
	PORT_BIT( 0xff, 0x38, IPT_AD_STICK_Y ) PORT_PLAYER(4) PORT_MINMAX(0x00,0x6f) PORT_SENSITIVITY(100) PORT_KEYDELTA(10) PORT_REVERSE
INPUT_PORTS_END
